        ...
        class s {
            ...
            addRule(e, t) {
                (t.position = this.position++),
                    ...
                    (this.matchAt +=
                        ((e) => RegExp(e.toString() + "|").exec("").length - 1)(
                            e
                        ) + 1);
            }
            compile() {
        ...
        return (
            ...
            (function t(s, i) {
                ...
                if (
                    ...
                    s.keywords &&
                        (s.keywords = B(s.keywords, e.case_insensitive)),
                    s.lexemes && l)
                )
                    throw Error(
    ...
    return ((e) => {
        ...
        function f(e, t, r, o) {
                ...
                null != R.subLanguage
                    ? (() => {
                          ...
                          if ("string" == typeof R.subLanguage) {
                              ...
                              e = p(
                                  M,
                                  R.subLanguage.length ? R.subLanguage : null
                              );
            ...
            function x(e) {
                ...
                return (
                    s.starts &&
                        (s.endSameAsBegin && (s.starts.endRe = s.endRe),
                        h(s.starts)),
        ...
        return (s) => {
            ...
            const o = {
                ...
                l = {
                    ...
                    returnBegin: !0,
                    contains: [
                        s.inherit(s.TITLE_MODE, { begin: /\w[\w\d_]*/ }),
                    ],
                    relevance: 0,
                };
            return {
        ...
        function e(e) {
            return ((...e) =>
                e
                    .map((e) =>
                        ((e) =>
                            e ? ("string" == typeof e ? e : e.source) : null)(e)
                    )
                    .join(""))("(", e, ")?");
        }
        return (t) => {
            const n = t.COMMENT("//", "$", { contains: [{ begin: /\\\n/ }] }),
                ...
                c = {
                    ...
                    contains: [
                        { begin: /\\\n/, relevance: 0 },
                        t.inherit(s, { className: "meta-string" }),
                        {
                    ...
                    contains: [
                        {
                            ...
                            contains: [
                                e.inherit(r, { className: "meta-string" }),
                            ],
                        },
                    ],
                },
            ...
            const a =
                ...
                o = [
                    ...
                    },
                    {
                        ...
                        contains: [
                            n.inherit(n.TITLE_MODE, { begin: a }),
                            l,
                        ].concat(b),
                    },
                    { begin: n.IDENT_RE + "::" },
